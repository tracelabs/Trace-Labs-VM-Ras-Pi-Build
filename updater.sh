...
wget -O updater-current.sh https://raw.githubusercontent.com/tracelabs/trace-labs-vm-ras-pi-build/main/updater-current.sh
chmod +x /home/osint/updater-current.sh
sudo /home/osint/updater-current.sh

sudo rm -f updater-current.sh

wget -O bookmarks.html https://raw.githubusercontent.com/tracelabs/trace-labs-vm-ras-pi-build/main/bookmarks.html
